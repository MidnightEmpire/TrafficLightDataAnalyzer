...
namespace TrafficLightDataAnalyzer.Model.RangeTransformer
{
    /// <summary>
    ...
    internal class TwoDigitClockFaceBrokeUpTransformationModel : IRangeTransformer<TwoDigitClockFaceValueModel, TwoDigitClockFaceObservationBinaryCodeValueModel>
    {
        ...
        /// Main constructor
        /// </summary>
        /// <param name="brokeUpBinaryCodesMasks">Broke-up binary codes masks reference value. Each gidit specify broken segments by "1" bit, working one by "0" bit</param>
